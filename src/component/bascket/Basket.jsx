        ...
        {cart.map((p) => (
          <section key={p.id}>
            <ul className="basket-ul">
              <li className="basket-li-img">
                <img src={p.img} alt="" />
              </li>
              <li className="basket-li-name">
                <span className="basket-span-name">name: </span>
                {p.name}
              </li>
              <li className="basket-li-newp">
                <span className="basket-span-newp">price: </span>${p.newP}
              </li>
              <li className="addMinus-li-btn">
                <button
                  onClick={() => handleChange(p, -1)}
                  className="li-minus-btn"
                >
                  -
                </button>
              ...
              <div className="basket-btn-li-parent">
                ...
                <li>
                  <button className="basket-li-btn">order now</button>
                </li>
              </div>
            </ul>
          </section>
